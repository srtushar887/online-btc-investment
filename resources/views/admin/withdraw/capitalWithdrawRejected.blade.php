...
@section('admin')
    ...
    <div class="modal fade" id="usercapwithvidewreh" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form action="{{route('admin.user.cap.with.save')}}" method="post">
                    @csrf
...
@section('js')
    ...
    <script>
        ...
        function viewusercapwith(id)
        {

            $.ajax({
                type : "POST",
                url : "{{route('get.single.capwith')}}",
                data : {
                    '_token' : "{{csrf_token()}}",
                    'id' : id,
                },
        ...
        $(document).ready(function () {
            ...
            $('#alldep').DataTable({
                ...
                "processing": true,
                "serverSide": true,
                "ajax": "{{ route('get.users.capital.withdraw.rej') }}",
                columns: [
