...
@section('admin')
    ...
    <div class="modal fade" id="userperwithvidew" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#alldep').DataTable({
                ...
                "processing": true,
                "serverSide": true,
                "ajax": "{{ route('get.users.percenatge.withdraw') }}",
                columns: [
