...
@section('admin')
    ...
    <div class="modal fade" id="userperwithvidewreh" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
...
@section('js')
    ...
    <script>
        ...
        function viewuserperwithreg(id)
        {
        ...
        $(document).ready(function () {
            ...
            $('#alldep').DataTable({
                ...
                "processing": true,
                "serverSide": true,
                "ajax": "{{ route('get.users.percenatge.withdraw.rejected') }}",
                columns: [
