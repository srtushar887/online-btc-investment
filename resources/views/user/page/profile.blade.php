...
@section('user')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form class="card-box" action="{{route('user.profile.save')}}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="with_wallet" value="{{$user->with_wallet}}" id="autocomplete-ajax" class="form-control" autocomplete="off">
                    </div>
                    <br>
                    <div class="col-md-6">
